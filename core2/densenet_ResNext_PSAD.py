...
class PSAModule(nn.Module):
    ...
    def __init__(self, inplans, planes, conv_kernels=[3, 5], stride=1, conv_groups=[4, 8]):
...
class _DenseLayer(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate):        # 参数量Params size (MB): 13.84
        ...
        self.convA = nn.Conv2d(num_input_features, growth_rate, kernel_size=1, stride=1,bias=False)
