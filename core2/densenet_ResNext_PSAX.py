...
class PSAModule(nn.Module):
    ...
    def __init__(self, inplans, planes, conv_kernels=[3, 5], stride=1, conv_groups=[8, 16]):
...
class _DenseLayer(nn.Sequential):
    ...
    def forward(self, x):
        ...
        new_featuresA = self.convA(x)
        new_featuresA = self.bnA(new_featuresA)
        new_featuresA = self.reluA(new_featuresA)
        ...
        new_features = ys0 + ys1 + ys2 + ys3 + new_featuresA
