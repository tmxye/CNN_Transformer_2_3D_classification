    ...
    def forward(self, x):
        ...
        for s in range(self.scales):
            if s == 0:
                ...
                ys0 = self.conv2[s](new_features)
            elif s == 1:
                # ys1 = self.conv2[s-1](xs[s] + ys0)
                ys1 = self.conv2[s-1](new_features + ys0)
            elif s == 2:
                # ys2 = self.conv2[s-1](xs[s] + ys1)
                ys2 = self.conv2[s-1](ys0 + ys1)
            else:
                # ys3 = self.conv2[s-1](xs[s] + ys2)
                ys3 = self.conv2[s-1](ys1 + ys2)
        ...
        # ys2 = self.bnA(ys2)
        # ys3 = self.bnA(ys3)
        new_features = ys0 + ys1 + ys2 + ys3 + xs
