...
def se_resnet101(num_classes=1000, **kwargs):
    ...
    Args:
        num_classes = 1000 (default)
    """
    model = SEResNet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes, **kwargs)
    return model
...
def se_resnext101(num_classes=1000, **kwargs):
    """Constructs a SE-ResNeXt-101 model.

    Args:
        num_classes = 1000 (default)
    """
    model = SEResNeXt(BottleneckX, [3, 4, 23, 3], num_classes=num_classes, **kwargs)
    return model
