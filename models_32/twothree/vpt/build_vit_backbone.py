...
def build_vit_sup_models(
    ...
    model_type, crop_size, prompt_cfg=None, model_root=".data/modelweight", adapter_cfg=None, load_pretrain=True, vis=False
):
    # image size is the size of actual image
    model_root = "./data/modelweight"
    m2featdim = {
        "sup_vitb16_224": 768,
        "sup_vitb16": 768,
        "sup_vitl16_224": 1024,
    ...
    if load_pretrain:
        print("os.path.join(model_root, MODEL_ZOO[model_type]", os.path.join(model_root, MODEL_ZOO[model_type]))
