...
class CapsNet(nn.Module):
    ...
    def __init__(self, A=32, B=32, C=32, D=32, E=10, K=3, P=4, act_stage = 'class_caps', a_p_o = 'o', iters_routings=[2,2,2]):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=A//2,
                               kernel_size=5, stride=2, padding=2)          # 112*112
        self.convYXY1 = nn.Conv2d(in_channels=A//2, out_channels=A//2,
                               kernel_size=3, stride=2, padding=1)           # 56*56
        self.convYXY2 = nn.Conv2d(in_channels=A//2, out_channels=A//2,
                               kernel_size=3, stride=2, padding=1)           # 28*28
        self.convYXY3 = nn.Conv2d(in_channels=A//2, out_channels=A,
                               kernel_size=3, stride=2, padding=1)           # 14*14
