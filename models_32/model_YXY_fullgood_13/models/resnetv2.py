...
at https://github.com/google-research/big_transfer to match model_YXY_fullgood_13 interfaces. The BiT weights have
...
from models_32.model_YXY_fullgood_13.data import IMAGENET_INCEPTION_MEAN, IMAGENET_INCEPTION_STD
