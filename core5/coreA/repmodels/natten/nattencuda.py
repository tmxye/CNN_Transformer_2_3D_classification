...
nattenav_cuda = load(
    'nattenav_cuda', ['./coreA/repmodels/natten/src/nattenav_cuda.cpp', './coreA/repmodels/natten/src/nattenav_cuda_kernel.cu'], verbose=False)
nattenqkrpb_cuda = load(
    'nattenqkrpb_cuda', ['./coreA/repmodels/natten/src/nattenqkrpb_cuda.cpp', './coreA/repmodels/natten/src/nattenqkrpb_cuda_kernel.cu'], verbose=False)
