...
class RepVGGBlock_OREPA(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size,
                 ...
                 # 这里报错'ReLU' object has no attribute 'total_ops'
                 stride=1, padding=0, dilation=1, groups=1, padding_mode='zeros', deploy=False, use_se=False, nonlinear=None):
