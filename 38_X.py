...
# from dataset_YXY_CT import get_dataloaderYXY
# from Data import get_dataloaderYXY
from Data_X import get_dataloaderYXY
# from dataset_YXY_CXR import get_dataloaderYXY
...
# print_model_summary(network=model) 这句是tf的语句，这个好像用不了
    ...
    # optimizer = optim.Adam(params=model.parameters(), lr=5e-2, weight_decay=1e-5)
    ...
    # optimizer = optim.AdamW(params=model.parameters(), lr=lr, betas=(0.9, 0.999), weight_decay=0.05)
...
if __name__ == '__main__':
    ...
    p.add_argument("--batchsize", type=int, default=28)
    # p.add_argument("--batchsize", type=int, default=48)
