...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features):
        ...
        self.branch3x3 = nn.Conv2d(input_channels, int(output_channels*0.25), kernel_size=3, stride=2, padding=1)
        self.branch3 = nn.Conv2d(input_channels, int(output_channels), kernel_size=3, stride=1, padding=1)
        self.branch1x1 = nn.Conv2d(input_channels, int(output_channels*0.25), kernel_size=1, stride=2)
