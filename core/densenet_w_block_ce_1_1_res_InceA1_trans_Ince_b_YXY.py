...
class InceptionC(nn.Module):
    ...
    def __init__(self, input_channels, output_channels):
        ...
        # self.branch3x3a = BasicConv2d(int(output_channels*0.375), int(output_channels*0.5), kernel_size=(3, 1), padding=(1, 0))          #256---10.667       给12算
        # self.branch3x3b = BasicConv2d(int(output_channels*0.375), int(output_channels*0.5), kernel_size=(1, 3), padding=(0, 1))     #这里是256 +256      现在是12+12        目前是48
        ...
        self.branchpool = nn.Sequential(
            BasicConv2d(input_channels, int(output_channels*1), kernel_size=1),         #这里是256     256-----10.6667         待会用这个补    8
    ...
    def forward(self, x):
        ...
        # branch3x3a = self.branch3x3a(branch3x3_output)
        # branch3x3b = self.branch3x3b(branch3x3_output)
        #
        # branch3x3_output = [
        #     self.branch1x1(branch3x3a),
        #     self.branch1x1(branch3x3b)
        # ]
        ...
        # ]
        #
        # return torch.cat(branch3x3_output, 1)
...
class _TransitionLayer(nn.Sequential):
    def __init__(self, num_input_features, num_output_features):
        ...
        self.Inception_c = generate_inception_module(num_input_features, num_output_features, 1, InceptionC)
...
class SEDenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        # self.features = self._generate_inception_module(64, 64, 1, InceptionA_1_1)
