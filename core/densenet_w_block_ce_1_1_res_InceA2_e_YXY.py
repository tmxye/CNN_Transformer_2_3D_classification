...
class InceptionA_1_2(nn.Module):
    #输出尺寸是1536
    def __init__(self, input_channels):
        #"""Figure 6. The schema for 8×8 grid modules of the pure
        #Inceptionv4 network. This is the Inception-C block of Figure 9."""
        ...
        self.branch3x3 = nn.Sequential(
            BasicConv2d(input_channels, 32, kernel_size=1),        #384---16
            BasicConv2d(32, 40, kernel_size=(1, 3), padding=(0, 1)),       # 448---18.666666667     给20算
            BasicConv2d(40, 32, kernel_size=(3, 1), stride=2, padding=(1, 0)),     #512-----21.33333333       给24算
        )
...
class InceptionA_1_3(nn.Module):
    #输出尺寸是1536
    def __init__(self, input_channels, output_channels):
        ...
        #     BasicConv2d(int(output_channels*0.25), int(output_channels*0.375), kernel_size=(1, 3), padding=(0, 1)),       # 448---18.666666667     给20算
        #     BasicConv2d(int(output_channels*0.375), int(output_channels*0.25), kernel_size=(3, 1), padding=(1, 0)),     #512-----21.33333333       给24算
        #     BasicConv2d(int(output_channels*0.25), int(output_channels*0.375), kernel_size=(1, 3), padding=(0, 1)),       # 448---18.666666667     给20算
        #     BasicConv2d(int(output_channels*0.375), int(output_channels*0.25), kernel_size=(3, 1), padding=(1, 0)),     #512-----21.33333333       给24算
        #     BasicConv2d(int(output_channels*0.25), int(output_channels*0.375), kernel_size=(1, 3), padding=(0, 1)),       # 448---18.666666667     给20算
        #     BasicConv2d(int(output_channels*0.375), int(output_channels*0.25), kernel_size=(3, 1), stride=2, padding=(1, 0)),     #512-----21.33333333       给24算
        # )
        ...
        self.branch3x3stack = nn.Sequential(
            ...
            BasicConv2d(int(output_channels*0.25), int(output_channels*0.375), kernel_size=(1, 3), padding=(0, 1)),       # 448---18.666666667     给20算
            BasicConv2d(int(output_channels*0.375), int(output_channels*0.25), kernel_size=(3, 1), padding=(1, 0)),     #512-----21.33333333       给24算
            BasicConv2d(int(output_channels * 0.25), int(output_channels * 0.25), kernel_size=1, stride=2),
        )
    ...
    def forward(self, x):
        # branch7x7stack_output = self.branch7x7stack(x)
...
class InceptionA_1_5(nn.Module):
    #输出尺寸是1536
    def __init__(self, input_channels, output_channels):
        #"""Figure 6. The schema for 8×8 grid modules of the pure
        #Inceptionv4 network. This is the Inception-C block of Figure 9."""
        ...
        self.branch3x3 = nn.Sequential(
            ...
            # BasicConv2d(16, 20, kernel_size=(1, 3), padding=(0, 1)),       # 448---18.666666667     给20算
            # BasicConv2d(20, 16, kernel_size=(3, 1), stride=2, padding=(1, 0)),     #512-----21.33333333       给24算
            BasicConv2d(input_channels, int(output_channels*0.25), kernel_size=3, stride=2, padding=1),
            # BasicConv2d(16, 16, kernel_size=1, stride=2)
        )
...
class SEDenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.Inception_c = self._generate_inception_module(3, 64, 1, InceptionA_1_5)
        ...
        self.features = self._generate_inception_module(64, 64, 1, InceptionA_1_5)
