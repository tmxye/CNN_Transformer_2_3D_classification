...
class Inception(nn.Module):         #这里都添加了     , stride=2
    def __init__(self, input_channels, n1x1, n3x3_reduce, n3x3, n5x5_reduce, n5x5, pool_proj):
        ...
        self.b1 = nn.Sequential(
            nn.Conv2d(input_channels, n1x1, stride=2, kernel_size=1),
            nn.BatchNorm2d(n1x1),
        ...
        self.b2 = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Conv2d(n3x3_reduce, n3x3, stride=2, kernel_size=3, padding=1),
            nn.BatchNorm2d(n3x3),
            nn.ReLU(inplace=True)
        )
        ...
        self.b3 = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Conv2d(n5x5, n5x5, stride=2, kernel_size=3, padding=1),
            nn.BatchNorm2d(n5x5),
            nn.ReLU(inplace=True)
        )
        ...
        self.b4 = nn.Sequential(
            ...
            nn.Conv2d(input_channels, pool_proj, stride=2, kernel_size=1),
...
class _DenseLayer(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate):
        ...
        # 原本的growth_rate改为  bn_size * growth_rate
        self.add_module('conv2', nn.Conv2d(bn_size * growth_rate, bn_size * growth_rate,
                        kernel_size=(1, 3), stride=1, padding=(0, 1), bias=False)),
        self.add_module('conv2', nn.Conv2d(bn_size * growth_rate, growth_rate,
                        kernel_size=(3, 1), stride=1, padding=(1, 0), bias=False)),
...
class SEDenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.a3 = Inception(3, 16, 24, 32, 4, 8, 8)     #这样通道数是256
