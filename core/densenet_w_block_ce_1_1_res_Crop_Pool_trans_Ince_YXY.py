...
class _TransitionLayer(nn.Sequential):
    def __init__(self, num_input_features, num_output_features):
        ...
        self.conv_Crop = BasicConv2d(num_input_features, int(num_output_features * 0.25), kernel_size=1, stride=1)
    ...
    def forward(self, x):
        # # new_features = super(_DenseLayer, self).forward(x)
        # torch.Size([16, 256, 14, 14]) 第一个是batchsize 第二个是通道数   第三个是尺寸
        ...
        if np.size(x, 2) == 56:
            ...
            out[..., 0::7, 1::7] = Crop_trans[..., 0::6, 0::6]
            out[..., 1::7, 0::7] = Crop_trans[..., 0::6, 0::6]
            out[..., 1::7, 1::7] = Crop_trans[..., 0::6, 0::6]
            out[..., 2::7, 0::7] = Crop_trans[..., 1::6, 0::6]
            out[..., 2::7, 1::7] = Crop_trans[..., 1::6, 0::6]
            out[..., 3::7, 0::7] = Crop_trans[..., 1::6, 0::6]
            out[..., 3::7, 1::7] = Crop_trans[..., 1::6, 0::6]
            # print('hello')
        ...
        Inception_c_out = self.Inception_c(x)
