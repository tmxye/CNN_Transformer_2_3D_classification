...
class BasicConv2d(nn.Module):
    def __init__(self, input_channels, output_channels, **kwargs):
        ...
        #   出现问题：File "Y:\04DenseNet_SA_SE_MultiClass\core\densenet_w_block_ce_1_1_res_InceA2_e_trans_resInce_pool2_2M_Nres_Crop_YXY.py", line 399, in forward        #     branch3x3stack_output = self.branch3x3stack(x)
        #   File "Y:\04DenseNet_SA_SE_MultiClass\core\densenet_w_block_ce_1_1_res_InceA2_e_trans_resInce_pool2_2M_Nres_Crop_YXY.py", line 39, in forward        #     x = self.bn(x)
        #  Tensor for argument #2 'weight' is on CPU, but expected it to be on GPU (while checking arguments for cudnn_batch_norm)
        # 因此加入上面这个      https://blog.csdn.net/YoJayC/article/details/109648503      是batchnorm1d的通病       #        # 最后在__init__函数中将定义的函数转到GPU上得到解决
        # self.bn
...
class InceptionA_1_5_res(nn.Module):
    ...
    def __init__(self, input_channels, output_channels):
        ...
        self.branchpool = nn.Sequential(
            ...
            nn.AvgPool2d(kernel_size=2, stride=2),       #这里是256     256-----10.6667         待会用这个补    8
        )           #这里是 256        最后合起来是1536          现在合算起来是64-48=16     每个补8即可
...
class _TransitionLayer(nn.Sequential):
    ...
    def forward(self, x, firstbatchsize=16):
        ...
        if np.size(x, 2) == 56:
            ...
            # 第一排的数据，6个值变成7个值
            out[..., 0::7, 0::7] = Crop_trans[..., 0::6, 0::6]
            out[..., 0::7, 1::7] = Crop_trans[..., 0::6, 1::6]
            out[..., 0::7, 2::7] = Crop_trans[..., 0::6, 2::6]
            out[..., 0::7, 3::7] = Crop_trans[..., 0::6, 3::6]
            out[..., 0::7, 4::7] = Crop_trans[..., 0::6, 4::6]
            out[..., 0::7, 5::7] = Crop_trans[..., 0::6, 5::6]
            out[..., 0::7, 6::7] = Crop_trans[..., 0::6, 5::6]

            # 第二排的数据
            out[..., 1::7, 0::7] = Crop_trans[..., 1::6, 0::6]
            out[..., 1::7, 1::7] = Crop_trans[..., 1::6, 1::6]
            out[..., 1::7, 2::7] = Crop_trans[..., 1::6, 2::6]
            out[..., 1::7, 3::7] = Crop_trans[..., 1::6, 3::6]
            out[..., 1::7, 4::7] = Crop_trans[..., 1::6, 4::6]
            out[..., 1::7, 5::7] = Crop_trans[..., 1::6, 5::6]
            out[..., 1::7, 6::7] = Crop_trans[..., 1::6, 5::6]

            # 第三排的数据
            out[..., 2::7, 0::7] = Crop_trans[..., 2::6, 0::6]
            out[..., 2::7, 1::7] = Crop_trans[..., 2::6, 1::6]
            out[..., 2::7, 2::7] = Crop_trans[..., 2::6, 2::6]
            out[..., 2::7, 3::7] = Crop_trans[..., 2::6, 3::6]
            out[..., 2::7, 4::7] = Crop_trans[..., 2::6, 4::6]
            out[..., 2::7, 5::7] = Crop_trans[..., 2::6, 5::6]
            out[..., 2::7, 6::7] = Crop_trans[..., 2::6, 5::6]

            # 第四排的数据
            out[..., 3::7, 0::7] = Crop_trans[..., 3::6, 0::6]
            out[..., 3::7, 1::7] = Crop_trans[..., 3::6, 1::6]
            out[..., 3::7, 2::7] = Crop_trans[..., 3::6, 2::6]
            out[..., 3::7, 3::7] = Crop_trans[..., 3::6, 3::6]
            out[..., 3::7, 4::7] = Crop_trans[..., 3::6, 4::6]
            out[..., 3::7, 5::7] = Crop_trans[..., 3::6, 5::6]
            out[..., 3::7, 6::7] = Crop_trans[..., 3::6, 5::6]

            # 第五排的数据
            out[..., 4::7, 0::7] = Crop_trans[..., 4::6, 0::6]
            out[..., 4::7, 1::7] = Crop_trans[..., 4::6, 1::6]
            out[..., 4::7, 2::7] = Crop_trans[..., 4::6, 2::6]
            out[..., 4::7, 3::7] = Crop_trans[..., 4::6, 3::6]
            out[..., 4::7, 4::7] = Crop_trans[..., 4::6, 4::6]
            out[..., 4::7, 5::7] = Crop_trans[..., 4::6, 5::6]
            out[..., 4::7, 6::7] = Crop_trans[..., 4::6, 5::6]

            # 第六排的数据
            out[..., 5::7, 0::7] = Crop_trans[..., 5::6, 0::6]
            out[..., 5::7, 1::7] = Crop_trans[..., 5::6, 1::6]
            out[..., 5::7, 2::7] = Crop_trans[..., 5::6, 2::6]
            out[..., 5::7, 3::7] = Crop_trans[..., 5::6, 3::6]
            out[..., 5::7, 4::7] = Crop_trans[..., 5::6, 4::6]
            out[..., 5::7, 5::7] = Crop_trans[..., 5::6, 5::6]
            out[..., 5::7, 6::7] = Crop_trans[..., 5::6, 5::6]

            # 第七排的数据
            out[..., 6::7, 0::7] = Crop_trans[..., 5::6, 0::6]
            out[..., 6::7, 1::7] = Crop_trans[..., 5::6, 1::6]
            out[..., 6::7, 2::7] = Crop_trans[..., 5::6, 2::6]
            out[..., 6::7, 3::7] = Crop_trans[..., 5::6, 3::6]
            out[..., 6::7, 4::7] = Crop_trans[..., 5::6, 4::6]
            out[..., 6::7, 5::7] = Crop_trans[..., 5::6, 5::6]
            out[..., 6::7, 6::7] = Crop_trans[..., 5::6, 5::6]
...
class SEDenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.features = self._generate_inception_module(64, 64, 1, InceptionA_1_4_res)
