...
class InceptionA_1_1_res(nn.Module):
    ...
    def __init__(self, input_channels, output_channels):
        ...
        self.branch1x1 = BasicConv2d_New(input_channels, int(output_channels*0.25), kernel_size=1, stride=2)        #这里是256     256-----10.6667     待会用这个补  8
...
class InceptionA_1_4_res(nn.Module):
    ...
    def __init__(self, input_channels, output_channels):
        ...
        self.branch3x3stack = nn.Sequential(
            ...
            BasicConv2d_N(int(((input_channels*output_channels)**0.5)*0.5), int(output_channels*0.25), kernel_size=3, stride=2, padding=1),
        )
        ...
        self.branch3x3 = nn.Sequential(
            ...
            # BasicConv2d(16, 20, kernel_size=(1, 3), padding=(0, 1)),       # 448---18.666666667     给20算
            # BasicConv2d(20, 16, kernel_size=(3, 1), stride=2, padding=(1, 0)),     #512-----21.33333333       给24算
            BasicConv2d_N(input_channels, int(output_channels*0.25), kernel_size=3, stride=2, padding=1),
            # BasicConv2d(16, 16, kernel_size=1, stride=2)
        )

        self.branch1x1 = BasicConv2d_N(input_channels, int(output_channels*0.25), kernel_size=1, stride=2)        #这里是256     256-----10.6667     待会用这个补  8
...
class InceptionA_1_5_res(nn.Module):
    ...
    def __init__(self, input_channels, output_channels):
        ...
        self.branch3x3stack = nn.Sequential(
            ...
            BasicConv2d(int(((input_channels*output_channels)**0.5)*0.5), int(output_channels*0.25), kernel_size=3, stride=2, padding=1),
        )
