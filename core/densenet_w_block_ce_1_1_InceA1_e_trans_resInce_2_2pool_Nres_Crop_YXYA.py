...
class InceptionA_1_1_Dres(nn.Module):
    #输出尺寸是1536
    def __init__(self, input_channels, output_channels):
        #"""Figure 6. The schema for 8×8 grid modules of the pure
        #Inceptionv4 network. This is the Inception-C block of Figure 9."""
...
class InceptionA_1_4_Dres(nn.Module):
    #输出尺寸是1536
    def __init__(self, input_channels, output_channels):
        #"""Figure 6. The schema for 8×8 grid modules of the pure
        #Inceptionv4 network. This is the Inception-C block of Figure 9."""
...
class SEDenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        # self.Inception_c = self._generate_inception_module(3, 64, 1, InceptionA_1_1_Dres)
        #
        #
        # # self.features = nn.Sequential(OrderedDict([
        # #     ('norm0', nn.BatchNorm2d(num_init_features)),
        ...
        # # ]))
        #
        # self.features = self._generate_inception_module(64, 64, 1, InceptionA_1_4_Dres)
