...
class _DenseLayer(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate):
        ...
        self.scales = 2
        self.conv_1 = ACBlock(bn_size * growth_rate //2, growth_rate//2, kernel_size=3, stride=1,  padding=1, dilation=1, groups= 8,
                              padding_mode='zeros', deploy=False, gamma_init=1/3)
        self.conv_2 = ACBlock(bn_size * growth_rate //2, growth_rate//2, kernel_size=3, stride=1,  padding=1, dilation=1, groups= 8,
                              padding_mode='zeros', deploy=False, gamma_init=1/3)
