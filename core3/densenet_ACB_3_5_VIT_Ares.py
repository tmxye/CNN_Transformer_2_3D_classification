...
class _DenseLayer(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate):
        ...
        self.conv1 = nn.Conv2d(num_input_features, bn_size * growth_rate, kernel_size=1, stride=1, groups=1, bias=False)
...
class _DenseLayerD(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate):
        ...
        self.bn1 = nn.BatchNorm2d(num_input_features)
        self.relu1 = nn.ReLU(inplace=True)
        # self.conv1 = nn.Conv2d(num_input_features, growth_rate, kernel_size=1, stride=1, groups=growth_rate, bias=False)
...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features):
        ...
        self.conv1 = nn.Conv2d(num_input_features, num_output_features, kernel_size=1, stride=1, groups=1, bias=False)
...
class SEDenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        # num_features = 256
        self.resA = nn.Conv2d(num_init_features, num_features, kernel_size=1, stride=1, bias=False)
        ...
        # num_features = 512
        self.resB = nn.Conv2d(num_featuresB, num_features, kernel_size=1, stride=1, bias=False)
        ...
        # num_features = 1024
        self.resC = nn.Conv2d(num_featuresC, num_features, kernel_size=1, stride=1, bias=False)
