...
class MyDataset(torch.utils.data.Dataset):  # 创建自己的类：MyDataset,这个类是继承的torch.utils.data.Dataset
    ...
    def __getitem__(self, index):  # 这个方法是必须要有的，用于按照索引读取每个元素的具体内容
        ...
        # # print("img", img.shape)
        # # https://york1996.blog.csdn.net/article/details/102558704
        ...
        # # img = img.unsqueeze(4)
        # # img = np.concatenate((imgA, imgB, imgC, imgD), axis=3)
        # img = np.concatenate((imgA, imgB, imgC, imgD, imgA, imgB, imgC, imgD), axis=1)
