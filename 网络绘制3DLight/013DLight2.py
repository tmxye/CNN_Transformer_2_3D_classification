...
plt.plot(TPRandFPRD1['FP'], TPRandFPRD1['TP'], ls='-', lw=0.6, color=palette(3), label='3D-PoolFormer-S24-AUC=85.43%')
plt.plot(TPRandFPRF['FP'], TPRandFPRF['TP'], ls='-', lw=0.6, color=palette(2), label='3D-BEVT-AUC=85.62%')
...
plt.savefig('./02ROC曲线绘制/22ROC曲线绘制.jpg', dpi=600)
plt.savefig('./02ROC曲线绘制/22ROC曲线绘制.pdf')
plt.savefig('./02ROC曲线绘制/22ROC曲线绘制.eps')
print('画图结束啦')
plt.clf()
...
plt.savefig('./02P_R曲线绘制/02P_R_点曲线绘制D.jpg', dpi=600)
plt.savefig('./02P_R曲线绘制/02P_R_点曲线绘制D.pdf')
plt.savefig('./02P_R曲线绘制/02P_R_点曲线绘制D.eps')
...
plt.savefig('./02P_R曲线绘制/02P_R曲线绘制D.jpg', dpi=600)
plt.savefig('./02P_R曲线绘制/02P_R曲线绘制D.pdf')
plt.savefig('./02P_R曲线绘制/02P_R曲线绘制D.eps')
# plt.show()
print('画图P_R结束啦')
plt.clf()
...
plt.savefig('./04混淆矩阵/03混淆矩阵_1.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_A.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_B.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_C.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_D.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_E.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_F.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_G.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_H.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_A1A.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_A1.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_B1.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_C1.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_D1.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_E1.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_F1.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_G1.jpg', dpi=600)
plt.clf()
...
plt.ylabel('True label', fontsize=18)
plt.xlabel('Predicted label', fontsize=18)
plt.savefig('./04混淆矩阵/03混淆矩阵_H1.jpg', dpi=600)
plt.clf()
