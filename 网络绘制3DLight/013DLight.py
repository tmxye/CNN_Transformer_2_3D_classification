...
plt.rcParams['font.family'] = ['SongEuclid']
plt.rcParams['axes.unicode_minus']=False #用来正常显示负号
...
plt.plot(TPRandFPRA['FP'], TPRandFPRA['TP'], ls='-', lw=0.6, color=palette(7), label='3D-ResNet50-AUC=0.7947')
plt.plot(TPRandFPRB['FP'], TPRandFPRB['TP'], ls='-', lw=0.6, color=palette(6), label='3D-EfficientNet-b3-AUC=0.8053')
# plt.plot(TPRandFPRC['FP'], TPRandFPRC['TP'], ls='-', lw=0.6, color=palette(5), label='3D-ConvNeXt-S-AUC=0.8371')
plt.plot(TPRandFPRD['FP'], TPRandFPRD['TP'], ls='-', lw=0.6, color=palette(4), label='3D-SwinTransformer-S-AUC=0.8309')
# plt.plot(TPRandFPRE['FP'], TPRandFPRE['TP'], ls='-', lw=0.6, color=palette(3), label='CondenseNet-AUC=0.9426')
plt.plot(TPRandFPRD1['FP'], TPRandFPRD1['TP'], ls='-', lw=0.6, color=palette(3), label='3D-PoolFormer-S24-AUC=0.9543')
plt.plot(TPRandFPRF['FP'], TPRandFPRF['TP'], ls='-', lw=0.6, color=palette(2), label='3D-BEVT-AUC=0.9562')
plt.plot(TPRandFPRB1['FP'], TPRandFPRB1['TP'], ls='-.', lw=0.6, color=palette(7), label='3D-Mobile-ViT-AUC=0.8347')
plt.plot(TPRandFPRC['FP'], TPRandFPRC['TP'], ls='-', lw=0.6, color=palette(5), label='3D-EdgeNeXt-S-AUC=0.8439')
plt.plot(TPRandFPRG['FP'], TPRandFPRG['TP'], ls='-', lw=0.6, color=palette(1), label='3D-CVT-13-AUC=0.8401')
# plt.plot(TPRandFPRH['FP'], TPRandFPRH['TP'], ls='-', lw=0.6, color=palette(0), label='NAT-small-AUC=0.9701')
plt.plot(TPRandFPRH1['FP'], TPRandFPRH1['TP'], ls='-', lw=0.6, color=palette(8), label='3D-CMT-S-AUC=0.8538')
plt.plot(TPRandFPR['FP'], TPRandFPR['TP'], "b-", lw=0.6, label='NextVit-S-AUC=0.8620')
# plt.plot(TPRandFPRC1['FP'], TPRandFPRB1['TP'], ls='-.', lw=0.6, color=palette(6), label='Conformer-B-AUC=0.9721')
plt.plot(TPRandFPR1['FP'], TPRandFPR1['TP'], "r-", lw=0.6, label='3D-CCLightFormer(Ours)-AUC=0.8981')
...
plt.savefig('./02ROC曲线绘制/20ROC曲线绘制.jpg', dpi=600)
print('画图结束啦')
plt.clf()
...
plt.plot(recall, precision, "b-", lw=0.6, label='NextVit-S-PR={}'.format(round(pr_auc, 4)))
# plt.plot(ArecallC, AprecisionC, ls='-.', lw=0.6, color=paletteB(6), label='Conformer-B-PR={}'.format(round(pr_aucC1, 4)))
plt.plot(Arecall, Aprecision, "r-", lw=0.6, label='3D-CCLightFormer(Ours)-PR={}'.format(round(pr_auc1, 4)))
...
plt.savefig('./01P_R曲线绘制/02P_R_点曲线绘制C.jpg', dpi=600)
...
plt.plot(dict_1H1['R'], dict_1H1['P'], ls='-', lw=0.6, color=paletteA(8), label='3D-CMT-S-PR=0.8573')
plt.plot(dict_1['R'], dict_1['P'], "b-", lw=0.6, label='NextVit-S-PR={}'.format(round(pr_auc, 4)))
# plt.plot(dict_1C1['R'], dict_1C1['P'], ls='-.', lw=0.6, color=paletteA(3), label='Conformer-B-PR={}'.format(round(pr_aucC1, 4)))
plt.plot(dict_11['R'], dict_11['P'], "r-", lw=0.6, label='3D-CCLightFormer(Ours)-PR={}'.format(round(pr_auc1, 4)))
...
plt.savefig('./01P_R曲线绘制/01P_R曲线绘制C.jpg', dpi=600)
# plt.show()
print('画图P_R结束啦')
plt.clf()
...
plt.figure(figsize=(4.6, 5))
plt.imshow(cm, interpolation='nearest', cmap=plt.cm.Blues)
plt.title('3D-CCLightFormer', fontsize=30)
tick_marks = np.arange(len(classes))
plt.xticks(tick_marks, classes, rotation=0, fontsize=20)
plt.yticks(tick_marks, classes, fontsize=20)
thresh = cm.max() / 2.
