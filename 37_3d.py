...
from dataset_YXY_3d import get_dataloaderYXY
# from dataset_YXY_3dA import get_dataloaderYXY
# from dataset_YXY_3dB import get_dataloaderYXY
...
# print_model_summary(network=model) 这句是tf的语句，这个好像用不了
    ...
    # optimizer = optim.SGD(params=model.parameters(), lr=lr, momentum=0.9, weight_decay=4e-5)
