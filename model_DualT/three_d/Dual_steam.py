...
class HybridEmbed(nn.Module):
    def __init__(self, backbone, img_size=224, feature_size=None, in_chans=3, embed_dim=768):
        ...
        self.proj = nn.Conv3d(feature_dim, embed_dim, 1)
...
class MixVisionTransformer(nn.Module):
    ...
    #              norm_layer=None):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=2, embed_dim=[64, 128, 320, 512],
                 depth=[2, 2, 4, 1], num_heads=[1, 2, 5, 8], mlp_ratio=4., qkv_bias=True, qk_scale=None,
                 representation_size=None, drop_rate=0., attn_drop_rate=0., drop_path_rate=0., hybrid_backbone=None,
                 norm_layer=None):
        """
        ...
        if hybrid_backbone is not None:
            ...
            self.patch_embed1 = PatchEmbed3D(patch_size=(2, 4, 4), in_chans=in_chans, embed_dim=embed_dim[0],
            ...
            self.patch_embed2 = PatchEmbed3D(patch_size=(2, 4, 4), in_chans=embed_dim[0], embed_dim=embed_dim[1],
                norm_layer=norm_layer if self.patch_norm else None,)
            self.patch_embed3 = PatchEmbed3D(patch_size=(2, 4, 4), in_chans=embed_dim[1], embed_dim=embed_dim[2],
                norm_layer=norm_layer if self.patch_norm else None,)
            self.patch_embed4 = PatchEmbed3D(patch_size=(2, 4, 4), in_chans=embed_dim[2], embed_dim=embed_dim[3],
                norm_layer=norm_layer if self.patch_norm else None,)
        #     by YXY
