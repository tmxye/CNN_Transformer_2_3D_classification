...
class MobileViT(nn.Module):
    def __init__(self, img_size, features_list, d_list, transformer_depth, expansion, num_classes = 1000):
        ...
        self.stem = nn.Sequential(
            nn.Conv3d(in_channels = 3, out_channels = features_list[1], kernel_size = 3, stride = 2, padding = 1),
        ...
        self.stage1 = nn.Sequential(
            ...
            MobileVitBlock(in_channels=features_list[2], out_channels=features_list[3], d_model=d_list[0] // 4,
                           layers=transformer_depth[0], mlp_dim=d_list[0] // 4)
        )
        ...
        self.stage2 = nn.Sequential(
            ...
            MobileVitBlock(in_channels = features_list[4], out_channels = features_list[5], d_model = d_list[0] // 2,
        ...
        self.stage3 = nn.Sequential(
            ...
            MobileVitBlock(in_channels = features_list[6], out_channels = features_list[7], d_model = d_list[1],
                           layers = transformer_depth[1], mlp_dim = d_list[1] * 1)
        )
        ...
        self.stage4 = nn.Sequential(
            ...
            MobileVitBlock(in_channels = features_list[8], out_channels = features_list[9], d_model = d_list[2],
                           layers = transformer_depth[2], mlp_dim = d_list[2] * 1),
