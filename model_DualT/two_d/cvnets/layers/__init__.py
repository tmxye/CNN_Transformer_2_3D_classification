...
def layer_specific_args(parser: argparse.ArgumentParser):
    ...
    for file in os.listdir(layer_dir):
        ...
        if (
            ...
            module = importlib.import_module("model_DualT.two_d.cvnets.layers." + layer_name)
...
def arguments_nn_layers(parser: argparse.ArgumentParser):
    ...
    from model_DualT.two_d.cvnets.layers.activation import arguments_activation_fn

    parser = arguments_activation_fn(parser)

    from model_DualT.two_d.cvnets.layers.normalization import arguments_norm_layers
