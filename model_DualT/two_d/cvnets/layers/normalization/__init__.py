...
for file in os.listdir(norm_dir):
    ...
    if (
        ...
        module = importlib.import_module("model_DualT.two_d.cvnets.layers.normalization." + model_name)
...
from model_DualT.two_d.cvnets.layers.normalization.batch_norm import BatchNorm2d, BatchNorm1d, BatchNorm3d
from model_DualT.two_d.cvnets.layers.normalization.group_norm import GroupNorm
from model_DualT.two_d.cvnets.layers.normalization.instance_norm import InstanceNorm1d, InstanceNorm2d
from model_DualT.two_d.cvnets.layers.normalization.sync_batch_norm import SyncBatchNorm
from model_DualT.two_d.cvnets.layers.normalization.layer_norm import LayerNorm, LayerNorm2D
