...
import argparse
from model_DualT.two_d.cvnets.utils.download_utils import get_local_path
from model_DualT.two_d.cvnets.utils.ddp_utils import is_master, is_start_rank_node
from model_DualT.two_d.cvnets.utils.common_utils import check_frozen_norm_layer
...
def arguments_segmentation(parser: argparse.ArgumentParser):
    ...
    from model_DualT.two_d.cvnets.models.segmentation.heads import arguments_segmentation_head
...
for file in os.listdir(models_dir):
    ...
    if (
        ...
        module = importlib.import_module("model_DualT.two_d.cvnets.models.segmentation." + model_name)
