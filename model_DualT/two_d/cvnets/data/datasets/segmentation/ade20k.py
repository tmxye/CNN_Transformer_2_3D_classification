...
class ADE20KDataset(BaseImageDataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        setattr(opts, "model_DualT.two_d.cvnets.dataset.collate_fn_name_train", "default_collate_fn")
        setattr(opts, "model_DualT.two_d.cvnets.dataset.collate_fn_name_val", "default_collate_fn")
        setattr(opts, "model_DualT.two_d.cvnets.dataset.collate_fn_name_eval", None)
