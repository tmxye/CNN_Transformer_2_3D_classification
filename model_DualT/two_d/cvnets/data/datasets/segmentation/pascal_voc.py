...
class PascalVOCDataset(BaseImageDataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        use_coco_data = getattr(opts, "model_DualT.two_d.cvnets.dataset.pascal.use_coco_data", False)
        coco_root_dir = getattr(opts, "model_DualT.two_d.cvnets.dataset.pascal.coco_root_dir", None)
        root = self.root
