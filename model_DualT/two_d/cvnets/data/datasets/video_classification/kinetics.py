...
class KineticsDataset(BaseImageDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if is_training:
            metadata_file = getattr(opts, "model_DualT.two_d.cvnets.dataset.kinetics.metadata_file_train", None)
        else:
            metadata_file = getattr(opts, "model_DualT.two_d.cvnets.dataset.kinetics.metadata_file_val", None)
    ...
    def __repr__(self):
        from model_DualT.two_d.cvnets.utils.tensor_utils import video_size_from_opts
