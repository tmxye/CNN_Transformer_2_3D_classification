...
from model_DualT.two_d.cvnets.matcher_det import build_matcher
from model_DualT.two_d.cvnets.anchor_generator import build_anchor_generator
...
class COCODetectionSSD(COCODetection):
    """model_DualT.two_d.cvnets.dataset class for the MS COCO Object Detection using Single Shot Object Detector (SSD).
    ...
    def __init__(
        ...
        **kwargs
        ...
        setattr(opts, "model_DualT.two_d.cvnets.dataset.collate_fn_name_train", "coco_ssd_collate_fn")
        setattr(opts, "model_DualT.two_d.cvnets.dataset.collate_fn_name_val", "coco_ssd_collate_fn")
        setattr(opts, "model_DualT.two_d.cvnets.dataset.collate_fn_name_eval", "coco_ssd_collate_fn")
    ...
    def __repr__(self):
        from model_DualT.two_d.cvnets.utils.tensor_utils import image_size_from_opts
