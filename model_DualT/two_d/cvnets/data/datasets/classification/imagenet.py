...
class ImagenetDataset(BaseImageDataset, ImageFolder):
    ...
    def __init__(
        ...
        **kwargs
        ...
        setattr(opts, "model_DualT.two_d.cvnets.dataset.collate_fn_name_train", "imagenet_collate_fn")
        setattr(opts, "model_DualT.two_d.cvnets.dataset.collate_fn_name_val", "imagenet_collate_fn")
        setattr(opts, "model_DualT.two_d.cvnets.dataset.collate_fn_name_eval", "imagenet_collate_fn")
