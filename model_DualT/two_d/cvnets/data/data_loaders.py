...
def create_eval_loader(opts):
    ...
    setattr(
        opts, "model_DualT.two_d.cvnets.dataset.val_batch_size0", getattr(opts, "model_DualT.two_d.cvnets.dataset.eval_batch_size0", 1)
    )
    ...
    data_workers = getattr(opts, "model_DualT.two_d.cvnets.dataset.workers", 1)
...
def create_train_val_loader(opts):
    ...
    data_workers = getattr(opts, "model_DualT.two_d.cvnets.dataset.workers", 1)
    persistent_workers = getattr(opts, "model_DualT.two_d.cvnets.dataset.persistent_workers", False) and (
        data_workers > 0
    )
    pin_memory = getattr(opts, "model_DualT.two_d.cvnets.dataset.pin_memory", False)
    prefetch_factor = getattr(opts, "model_DualT.two_d.cvnets.dataset.prefetch_factor", 2)
